...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPANTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTICIPANTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTICIPANTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTICIPANTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPANTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTICIPANTS actions', async () => {
      const expectedActions = [
        {
