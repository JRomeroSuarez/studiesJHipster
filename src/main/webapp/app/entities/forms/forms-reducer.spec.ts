...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './forms.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORMS actions', async () => {
      const expectedActions = [
        {
