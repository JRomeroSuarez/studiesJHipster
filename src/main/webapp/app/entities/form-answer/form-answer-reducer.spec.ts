...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMANSWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FORMANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FORMANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FORMANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FORMANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FORMANSWER actions', async () => {
      const expectedActions = [
        {
